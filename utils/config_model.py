...
from models.procc import PROCC
...
def configure_model(args, dataset):
    ...
    elif args.model == 'procc':
        model = PROCC(dataset, args)
    ...
    optimizer_ft = optim.Adam(optim_params, lr=args.lr_ft, weight_decay=args.wd)

    model.is_open = is_open

    return image_extractor, model, optimizer, optimizer_ft
